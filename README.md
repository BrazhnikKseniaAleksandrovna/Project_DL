...
Мы решили также хотели рассмотреть предобученные модели, но, к сожалению, из-за неустойчивой работы datasphera и проблемой с библиотеками, у нас не получилось это сделать.
